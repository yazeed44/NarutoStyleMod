...
public class EntityNarutoStylePainting extends EntityHanging {
	 public EnumArt art;

	    public EntityNarutoStylePainting(World par1World)
	    {
	        super(par1World);
	    }

	    public EntityNarutoStylePainting(World par1World, int par2, int par3, int par4, int par5)
	    {
	    ...
	    public EntityNarutoStylePainting(World par1World, int par2, int par3, int par4, int par5, String par6Str)
	    {
