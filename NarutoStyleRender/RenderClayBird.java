...
public class RenderClayBird extends Render {
	private Item field_94151_a;
	private int field_94150_f;
	public RenderClayBird(Item par1, int par2)
	{
	this.field_94151_a = par1;
	this.field_94150_f = par2;
	}
	public RenderClayBird(Item par1)
	{
	this(par1, 0);
	}
	/**
	...
	*/
	...
	{
	Icon icon = NarutoStyle_main.ClayBird.getIconFromDamage(this.field_94150_f);
	if (icon != null)
	{
	GL11.glPushMatrix();
