...
public class RenderClaySpider extends Render
{
    private Item field_94151_a;
    private int field_94150_f;

    public RenderClaySpider(Item par1Item, int par2)
    {
        this.field_94151_a = par1Item;
        this.field_94150_f = par2;
    }

    public RenderClaySpider(Item par1Item)
    {
        this(par1Item, 0);
    }
    ...
    {
        Icon icon = NarutoStyle_main.ClaySpider.getIconFromDamage(this.field_94150_f);
