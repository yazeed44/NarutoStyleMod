...
public class ModelNarutoStyle extends ModelBase
{
    ...
    public ModelNarutoStyle()
    {
        this(0.0F);
    }

    public ModelNarutoStyle(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelNarutoStyle(float par1, float par2, int par3, int par4)
    {
